...
public class PersonRideHistoryController {
    ...
    public List<RideHistoryDto> getRideHistory(@PathVariable String personId) {
        ...
        Set<String> passengerRideIds = passengerEntries.stream()
        ...
        Map<String, RideHistoryDto> merged = new HashMap<>();
